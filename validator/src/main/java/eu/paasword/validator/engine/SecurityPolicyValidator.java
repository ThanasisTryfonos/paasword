...
import eu.paasword.validator.engine.JenaDataSource;
import eu.paasword.validator.engine.ProblematicRules;
...
public class SecurityPolicyValidator {
    ...
    private static final Logger logger = Logger.getLogger(SecurityPolicyValidator.class.getName());
    ...
    public ValidationReport validate()
    {
        ...
        {
            logger.info("Contradictive Rules: " +  ruleContradictions.size());
        ...
        if(!policyContradictions.isEmpty())
        {
            ...
            logger.info("Contradictive Policies: " +  policyContradictions.size());
        ...
        if(!ruleSubsumptions.isEmpty())
        {
            ...
            logger.info("Subsumptive Rules: " +  ruleSubsumptions.size());
