package eu.paasword.annotation.interpreter.archive;

import eu.paasword.annotation.interpreter.util.FileUtils;
import eu.paasword.annotation.interpreter.util.StreamUtils;
...
//        AssertArgument.isNotNull(data, "data");
        ...
        try {
            ...
            try {
                ...
                logger.info("Unable to close input stream for archive entry '" + path + "'.");
            }
        }
...
//        AssertArgument.isNotNull(zipStream, "zipStream");
        ...
        try {
            ...
            try {
                ...
                logger.severe("Unexpected error closing EDI Mapping Model Zip stream.");
            }
        }
