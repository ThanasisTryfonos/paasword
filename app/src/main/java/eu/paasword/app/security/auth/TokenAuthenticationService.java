...
public class TokenAuthenticationService {
    ...
    public void addAuthentication(HttpServletResponse response, UserDetails authenticatedUser) {
        response.addHeader(AUTH_HEADER_NAME, TOKEN_TYPE.concat(tokenHandler.createTokenForUser(new User(authenticatedUser.getUsername(), "", authenticatedUser.getAuthorities()))));
    }
