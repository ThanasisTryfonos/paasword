 ...
 */
@Entity
@Table(name = "paas_provider_type", uniqueConstraints = @UniqueConstraint(columnNames = {"id"}))
public class PaaSProviderType implements Serializable {
    ...
    @Column(nullable = false, name = "adapter_implementation")
