 ...
 */
@Entity
@Table(name = "application_instance_activity", uniqueConstraints = @UniqueConstraint(columnNames = {"id"}))
public class ApplicationInstanceActivity implements Serializable {
    ...
    public ApplicationInstanceActivity() {
    }
