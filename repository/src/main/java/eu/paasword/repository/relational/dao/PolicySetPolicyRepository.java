...
@Repository
@Transactional
public interface PolicySetPolicyRepository extends JpaRepository<PolicySetPolicy, Long> {

    public List<PolicySetPolicy> findByPolicy(Policy policy);

    public List<PolicySetPolicy> findByPolicySet(PolicySet policySetlicy);
