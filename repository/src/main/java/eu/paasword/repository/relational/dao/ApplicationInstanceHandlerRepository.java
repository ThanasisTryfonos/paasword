...
@Repository
@Transactional
public interface ApplicationInstanceHandlerRepository extends JpaRepository<ApplicationInstanceHandler, Long> {

    @Query("select l from ApplicationInstanceHandler l where l.applicationInstanceID is not null and l.applicationInstanceID.id = ?1")
