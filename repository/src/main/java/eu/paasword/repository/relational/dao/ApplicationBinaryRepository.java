...
@Repository
@Transactional
public interface ApplicationBinaryRepository extends JpaRepository<ApplicationBinary, Long> {

    ApplicationBinary findByApplicationID(Application application);
